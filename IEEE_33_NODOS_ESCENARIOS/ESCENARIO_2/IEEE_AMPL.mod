...
#---------------------------------------------------------------------------
var I{Ol, PH};			   # Corriente en las líneas
var P{Ol, PH};		       # Potencia activa en las líneas
var Q{Ol, PH};		       # Potencia reactiva en las líneas
var V{Ob, PH};			   # Tensión en las barras
